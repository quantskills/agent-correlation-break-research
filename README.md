<h1 align="center">相关性断裂研究 Agent</h1>

<p align="center"><b>简体中文</b> | <a href="README.en.md">English</a></p>

<p align="center">用 Pandadata 主力合约相关性数据，判断组合原有的相关性与分散假设是否还可靠。</p>
...
> 这是 QuantSkills 组织的 Pandadata 研究/盯盘 Agent：`agent-correlation-break-research`。它面向研究员、交易者和用 AI Agent 做市场复盘的用户，把真实市场数据整理成**可阅读、可复盘、可交接**的研究材料 —— 不自动下单，也不输出无条件买卖指令。
...
```mermaid
flowchart LR
    q["研究问题"] --> data["Pandadata 取数<br/>get_future_dominant_corr"]
...
<table>
<tr>
<td width="33%" align="center"><img src="outputs/live/charts/correlation_heatmap.png" width="100%"><br><sub><b>主证据</b><br/>相关性热力图</sub></td>
<td width="33%" align="center"><img src="outputs/live/charts/cross_correlation_bars.png" width="100%"><br><sub><b>辅助证据</b><br/>跨品种相关性柱状图</sub></td>
...
| | `correlation_break_memo.md` | 文字版研判备忘，便于贴进研究日志。 |
| | `break_scorecard.json` | 结构化打分卡：各维度评分与判断依据。 |
...
| | `risk_questions.md` | 需进一步确认的风险问题清单。 |
...
| **数据底稿** | `correlation_matrix.csv` | 相关性矩阵原表。 |
...
```text
用 agent-correlation-break-research，基于 Pandadata 生成市场状态研判；
